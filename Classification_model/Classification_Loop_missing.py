...
if os.path.exists('/home/priscila.a/TG-Biomed/Classification_model/Nets_hpc_missing') == False: 
    os.makedirs('/home/priscila.a/TG-Biomed/Classification_model/Nets_hpc_missing')
...
#     print('Random State: %d' % (random_state))
    ...
    # save the scaler
    dump(scaler_x, open('/home/priscila.a/TG-Biomed/Classification_model/Nets_hpc_missing/'+zero_filled_number+'_scaler_x.pkl', 'wb'))
    ...
    for epoch in range(epochs):
        ...
        if epoch == 0 or (epoch + 1) % 100 == 0:
            ...
            save_checkpoint({'epoch': epoch + 1,
                            ...
                            }, is_best, '/home/priscila.a/TG-Biomed/Classification_model/Nets_hpc_missing/'+zero_filled_number+'_model_best.pth.tar')
...
#             print('   R-corrcoef: %s' % (str(r_vali)))
    ...
    # Load best model
    checkpoint = torch.load('/home/priscila.a/TG-Biomed/Classification_model/Nets_hpc_missing/'+zero_filled_number+'_model_best.pth.tar')
...
#     print('R-corrcoef: %s' % (str(r)))
    ...
    df_nets.to_excel ('/home/priscila.a/TG-Biomed/Classification_model/Nets_hpc_missing/classification_nets_hpc_missing'+sys.argv[3]+'.xlsx', index = False, header=True)
